...
def init_args():
    ...
    parser_ramp.add_argument(
        "-f", "--font", type=pathlib.Path, required=True, help="specify the font file"
    )
    parser_ramp.add_argument(
        "-c",
        "--character-set",
    ...
    parser_ramp.add_argument(
        "-g", "--graph", action="store_true", help="Print ramp graph"
    )
    parser_ramp.add_argument(
        "-w",
        "--width",
    ...
    parser_image.add_argument(
        "-i", "--image", type=pathlib.Path, required=True, help="specify the image"
    )
    parser_image.add_argument(
        "-f", "--font", type=pathlib.Path, required=True, help="specify the font file"
    )
    ...
    parser_image.add_argument(
        "-r", "--reverse", action="store_true", help="reverse the ramp order"
    )
    parser_image.add_argument(
        "-w",
        "--width",
